...
function App() {
    ...
    return (
        <React.Box rows={["45px", "50%"]} columns="70%" gap={35}>
            <React.Typography variant="solid" type="h1">Counter App</React.Typography>
            <React.Box variant="soft" columns={"100%"} rows={["25%", "65%"]} gap={"5%"} padding={"5%"}>
...
React.serve(
    ...
    , {
        customConnection: {
            ...
            server: {
                customTransport: socketIoToTransport(
                    io
                )
            }
        },
