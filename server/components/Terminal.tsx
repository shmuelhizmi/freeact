...
export function Terminal(props: TerminalProps) {
    ...
    useEffect(() => {
        ...
        const pty = new PTY((data) => {
            ...
            props.initialExecution.command || defaultBash,
    ...
    return port && <ViewsProvider<Components>>{({ Terminal: TerminalView }) => <TerminalView port={String(port)} />}</ViewsProvider>
}
